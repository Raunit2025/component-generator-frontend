    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-8 animated-gradient">
      <div className="text-center max-w-3xl z-10">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-6">
          <Link
            href="/auth/login"
            className="group relative inline-block rounded-lg bg-blue-600 px-8 py-3 text-lg font-bold text-white shadow-lg transition-transform transform-gpu hover:scale-105"
          >
          ...
          <Link
            href="/auth/signup"
            className="group relative inline-block rounded-lg bg-gray-800 px-8 py-3 text-lg font-bold text-white shadow-lg transition-transform transform-gpu hover:scale-105"
          >
